...
if __name__ == '__main__':
    ...
    centroids_check = np.loadtxt('centroids.csv').astype(np.float32)
    
    ''' Create code below to compute the 5 centroids based on the given assignments using numpy, multiprocessing, and numba '''
